...
import com.sanalberto.svp.entities.DepartamentosEntity;
...
public class DepartamentoRepository {
    ...
    public ArrayList<DepartamentosEntity> listarDepartamentos(){
        ...
        try(EntityManager em = emf.createEntityManager()){
            ...
            Query listarDepsquery = em.createQuery("select d from DepartamentosEntity d");
            listadoDepartamentos = (List<DepartamentosEntity>)  listarDepsquery.getResultList();
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return new ArrayList<>(listadoDepartamentos);
    }
    ...
    public DepartamentosEntity depById(int id){
        ...
        try(EntityManager em = emf.createEntityManager()){
            ...
            //Query depQuery = em.createQuery("select d from DepartamentosEntity d where d.deptNo = :pDepId");
    ...
    public DepartamentosEntity depByName(String nombre){
        ...
        try(EntityManager em = emf.createEntityManager()){
            Query depQuery = em.createQuery("select d from DepartamentosEntity d where d.dnombre = :pDepNombre");

...
import com.sanalberto.svp.entities.EmpleadosEntity;
...
public class EmpleadoRepository {
    ...
    public ArrayList<EmpleadosEntity> listarEmpleados() throws SQLException{
        ...
        try(EntityManager em = emf.createEntityManager()){
            ...
            Query listarEmpsquery = em.createQuery("select e from EmpleadosEntity e");
    ...
    public int empleadoByName(String apellido) throws SQLException {
        ...
        try (EntityManager em = emf.createEntityManager()) {
            ...
            Query depQuery = em.createQuery("select e.empNo from EmpleadosEntity e where e.apellido = :pEmpNombre");
    ...
    public ArrayList<Integer> empleadosByName(String apellido)  {
        ...
        try(EntityManager em = emf.createEntityManager()){
            Query idsEmpQuery = em.createQuery("select e.empNo from EmpleadosEntity e where e.apellido = :pApellido");
    ...
    public boolean borrarEmpleado(int idEmpleado){
        ...
        try(EntityManager em = emf.createEntityManager()){
            ...
            EmpleadosEntity emp = (EmpleadosEntity) em.createQuery("select e from EmpleadosEntity e where e.empNo = :pId").
    ...
    public boolean empIdExiste(int idEmpleado) throws SQLException{
        boolean existe = true;
        try(EntityManager em = emf.createEntityManager()){
            Query idEmpQuery = em.createQuery("select e.apellido from EmpleadosEntity e where e.empNo = :pIdEmp");
